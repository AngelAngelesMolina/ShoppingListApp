...
//GETTING DATA FROM THE INTENT
        ...
        viewModel.getItemsListObserver().observe(this, new Observer<List<Items>>() {
            ...
            public void onChanged(List<Items> items) {
                if (items == null) {
                    ...
                    findViewById(R.id.noneResult).setVisibility(View.VISIBLE);
                } else {
                    itemsListAdapter.setCategoryList(items);
                    findViewById(R.id.noneResult).setVisibility(View.GONE);
    ...
    public void updateNewItem(String newNameItem) {
        itemToUpdate.itemName = newNameItem;
